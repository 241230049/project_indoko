...
<div class="max-w-6xl mx-auto space-y-8">
    <div class="text-center">
        <h1 class="text-3xl font-bold text-slate-800">Daftar Feed Sosial Aksi</h1>
    ...
    <form action="/feeds" method="GET" class="bg-white p-4 rounded-xl shadow-sm border flex flex-col md:flex-row gap-4">
        ...
        @if(request()->has('search') || request()->has('min_like'))
            <a href="/feeds" class="bg-slate-200 hover:bg-slate-300 rounded-lg text-center flex items-center justify-center text-slate-700 text-sm px-4 py-2">
                Reset
            </a>
        @endif
    </form>
